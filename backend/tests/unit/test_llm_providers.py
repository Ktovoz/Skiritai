...
class TestProviderRegistry:
    ...
    def test_get_provider_by_explicit_name(self):
        from app.engine.llm.registry import get_provider
    ...
    def test_register_provider_adds_to_registry(self):
        ...
        from app.engine.llm.registry import register_provider, get_provider
        ...
        try:
            ...
            import app.engine.llm.registry as reg
            reg._PROVIDERS.pop("fake", None)

    def test_register_provider_normalizes_name_to_lowercase(self):
        from app.engine.llm.base import LLMProvider
        from app.engine.llm.registry import register_provider
...
class TestOpenAIProvider:
    ...
    def test_build_uses_default_model(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            with patch("app.engine.llm.openai_provider.ChatOpenAI") as mock_chat:
                provider.build()
...
class TestAnthropicProvider:
    ...
    def test_build_uses_default_model(self):
        from app.engine.llm import anthropic_provider as mod
...
class TestProviderIntegration:
    ...
    def test_openai_provider_roundtrip(self):
        ...
        with patch("app.engine.llm.openai_provider.ChatOpenAI") as mock:
