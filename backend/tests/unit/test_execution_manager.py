...
class TestRegisterExecution:
    ...
    def test_register_new_task(self):
        from app.engine.execution_manager import register_execution, is_running, _executions
    ...
    def test_register_overwrites_existing(self):
        from app.engine.execution_manager import register_execution, _executions
    ...
    def test_is_running_false_for_unknown_case(self):
        from app.engine.execution_manager import is_running

        _ensure_clean()
        assert is_running("nonexistent") is False

    def test_is_running_false_for_done_task(self):
        from app.engine.execution_manager import register_execution, is_running
...
class TestCancelExecution:
    ...
    def test_cancel_running_task(self):
        from app.engine.execution_manager import register_execution, cancel_execution, _executions
    ...
    def test_cancel_already_done_task(self):
        from app.engine.execution_manager import register_execution, cancel_execution
...
class TestUnregisterExecution:
    ...
    def test_unregister_existing(self):
        from app.engine.execution_manager import register_execution, unregister_execution, _executions
    ...
    def test_unregister_nonexistent_no_error(self):
        from app.engine.execution_manager import unregister_execution
...
class TestExecutionLifecycle:
    ...
    def test_full_lifecycle(self):
        from app.engine.execution_manager import (
